...
if __name__ == '__main__':
	...
	print("srun --wckey=ird:gama -n " + str(args.core) + " --partition=cn -J COMOKIT --exclusive -N " + str(args.node) + " ----ntasks-per-node=" + str(args.core) + " -o log.txt --comment COMOKIT --multi-prog gama-headless.conf &")
